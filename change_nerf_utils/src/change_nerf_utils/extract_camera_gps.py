...
try:
    ...
    df_final = df_final[['sensor_id', 'latitude', 'longitude', 'altitude']]
    
    # Save the updated DataFrame to a new CSV
    output_file_path = args.output_log
    
    # Drop rows where sensor_id is 'GPS' or lat/lon are missing
    df_final = df_final[
        (df_final['sensor_id'] != 'GPS') &
