...
class two_query_localize:
    def __init__(self, main_query, llm_query, cluster_min_points, detection_threshold, travel_params):
    ...
    def cam_info_callback(self, cam_info):
        ...
        self.pclouds=pcloud_from_images(self.params)
    ...
    def is_new_image(self, new_poseM):
        ...
        vec1=np.matmul(self.last_image['poseM'],[1,0,0,1])
        vec2=np.matmul(new_poseM,[1,0,0,1])
        pdb.set_trace()
...
if __name__ == '__main__': 
    ...
    IT=two_query_localize(args.main_target,args.llm_target,args.num_points,args.detection_threshold,[args.min_travel_dist,args.min_travel_angle])
    rospy.spin()
