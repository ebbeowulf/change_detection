...
def combine_matches(test_file_dict, detection_threshold=0.5, min_cluster_points=10000):
    try:
        if detection_threshold<MIN_DETECTION_THRESHOLD:
            ...
            objects_llm=get_clusters(save_main, test_file_dict['raw_main'], MIN_DETECTION_THRESHOLD, min_cluster_points)
            objects_main=get_clusters(save_llm, test_file_dict['raw_llm'], MIN_DETECTION_THRESHOLD, min_cluster_points)
        else:
            ...
            objects_llm=get_clusters(save_main, test_file_dict['raw_main'], detection_threshold, min_cluster_points)
            objects_main=get_clusters(save_llm, test_file_dict['raw_llm'], detection_threshold, min_cluster_points)
